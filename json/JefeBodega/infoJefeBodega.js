$(document).ready(function(){
	...
	function traerDatos(){
		...
		peticion.open('GET', '../../json/JefeBodega/php/informacionJefeBodega');
	...
	setInterval(function(){
		$.ajax({
			url: '../../json/JefeBodega/php/validarSesion',
			type: 'POST',
			dataType: 'html',
	...
	setInterval(function(){
		$.ajax({
			url: '../../json/JefeBodega/php/infoActual',
			type: 'POST',
			dataType: 'json',
			data: {consulta: 'consulta'},
		})
