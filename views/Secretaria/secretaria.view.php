...
<!-- ESTILOS -->
<link rel="stylesheet" href="<?php echo RUTA; ?>css/SI/Secretaria/estiloSecretaria.css">
		...
		<div class="barra-lateral col-12 col-sm-auto">
			...
			<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
				...
				<a class="menu-opcion seleccionado" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1" id="btn_solicitudes">
					<i class="icon-content_paste"></i><span><?php echo $lenguaje["Solicitudes"]; ?></span>
				</a>
				<!-- BTN #3 COLLAPSE ASPIRANTES -->
				<a class="menu-opcion" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapse3" id="btn_aspirantes">
					<i class="icon-user-check"></i><span><?php echo $lenguaje["Aspirantes"]; ?></span>
				</a>
				<!-- BTN #4 COLLAPSE EMPLEADOS -->
				<a class="menu-opcion" data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-controls="collapse4" id="btn_empleados">
					<i class="icon-users1"></i><span><?php echo $lenguaje["Empleados"]; ?></span>
				</a>
			...
			<span class="mx-5 mb-0 py-1 spm-miga d-none d-lg-block"><span id="modulo"><?php echo $lenguaje["Secretaria"]; ?></span>/<span id="ruta"><?php echo $lenguaje["Solicitudes"]; ?></span></span>
		</div>
		<!-- CONTENIDO CENTRAL -->
			...
			<div class="row d-none d-sm-block barra-superior mb-3">
				...
				<div class="notificaciones">
					...
					<div class="notificacion not1">
						...
						<span class="bg-info" id="cont_notif">0</span>
					</div>
					<div class="home">
					...
					<div id="accordion">
							...
							<div id="collapse1" class="collapse despliegue show" arial-labelledby="heading1" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-solicitudes">
										<iframe src="<?php echo RUTA; ?>SI/Secretaria/iframe/Solicitudes/solicitudesSecretaria" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
							...
							<div id="collapse3" class="collapse despliegue" arial-labelledby="heading3" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-eventos">
										<iframe src="<?php echo RUTA; ?>SI/Secretaria/iframe/Aspirantes/aspirantes" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="py-0 cotizaciones">
							<div id="collapse4" class="collapse despliegue" arial-labelledby="heading4" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-eventos">
										<iframe src="<?php echo RUTA; ?>SI/Secretaria/iframe/Empleados/empleados" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
							...
							<div id="collapse6" class="collapse despliegue" arial-labelledby="heading6" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-configuracion">
										<iframe src="<?php echo RUTA; ?>SI/Secretaria/iframe/Configuracion/configuracion" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
...
<!-- SCRIPS PROPIOS -->
<script src="<?php echo RUTA; ?>js/SI/Secretaria/scriptsSecretaria.js"></script>
<!-- SCRIPTS ALERTA -->
...
<!-- SCRIPTS INFORMACION SECRETARIA -->
<script src="<?php echo RUTA; ?>json/Secretaria/infoSecretaria.js"></script>
<!-- SCRIPTS IDIOMA -->
<script src="<?php echo RUTA; ?>json/Secretaria/idioma.js"></script>
<script>
