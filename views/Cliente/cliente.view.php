...
<link rel="stylesheet" href="<?php echo RUTA; ?>css/SI/Cliente/estiloCliente.css">
	...
	<div class="row">
		...
		<div class="barra-lateral col-12 col-sm-auto">
			...
			<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
				...
				<!-- BTN #2 COLLAPSE COTIZACIONES -->
				<a class="menu-opcion" data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-controls="collapse2" id="btn_eventos">
					<i class="icon-cake"></i><span><?php echo $lenguaje["Eventos"]; ?></span>
				</a>
				<!-- BTN #2 COLLAPSE COTIZACIONES -->
				<a class="menu-opcion" id="btn_cotizacion" href="<?php echo RUTA; ?>SI/Cotizacion/cotizacion">
					<i class="icon-restaurant"></i><span><?php echo $lenguaje["Cotizacion"]; ?></span>
				</a>
			...
			<span class="mx-5 mb-0 py-1 spm-miga d-none d-lg-block"><span id="modulo"><?php echo $lenguaje["Cliente"]; ?></span>/<span id="ruta"><?php echo $lenguaje["Solicitudes"]; ?></span></span>
		</div>
		<!-- CONTENIDO CENTRAL -->
			...
			<div class="row pr-3">
				<div class="columna col">
					<div id="accordion">
							...
							<div id="collapse1" class="collapse despliegue show" arial-labelledby="heading1" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-solicitudes">
										<iframe src="<?php echo RUTA; ?>SI/Cliente/iframe/Solicitudes/solicitudesCliente" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
						<!-- CARD #2 COTIZACIONES -->
						<div class="py-0 cotizaciones">
							<div id="collapse2" class="collapse despliegue" arial-labelledby="heading2" data-parent="#accordion">
								<!-- ACORDIO DE COTIZACIONES -->
								<div class="card card-body p-0">
									<div id="accordion-eventos">
										<iframe src="<?php echo RUTA; ?>SI/Cliente/iframe/Eventos/eventos" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
							...
							<div id="collapse6" class="collapse despliegue" arial-labelledby="heading6" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-configuracion">
										<iframe src="<?php echo RUTA; ?>SI/Cliente/iframe/Configuracion/configuracion" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
...
<!-- SCRIPS PROPIOS -->
<script src="<?php echo RUTA; ?>js/SI/Cliente/scriptsCliente.js"></script>
<!-- SCRIPTS ALERTA -->
...
<!-- SCRIPTS INFORMACION CLIENTE -->
<script src="<?php echo RUTA; ?>json/Cliente/infoCliente.js"></script>
<!-- SCRIPTS IDIOMA -->
<script src="<?php echo RUTA; ?>json/Cliente/idioma.js"></script>
<script>
