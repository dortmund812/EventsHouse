...
<!-- ESTILOS -->
<link rel="stylesheet" href="<?php echo RUTA; ?>css/SI/JefeBodega/estiloJefeBodega.css">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="barra-lateral col-12 col-sm-auto">
			<div class="titular">
				<h2><?php echo $lenguaje["Solicitud"]; ?></h2>
			</div>
			...
			<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
				...
				<a class="menu-opcion seleccionado" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1" id="btn_inventario">
					<i class="icon-clipboard"></i><span><?php echo $lenguaje["Inventario"]; ?></span>
				</a>
				<!-- BTN #3 COLLAPSE PRODUCTOS -->
				<a class="menu-opcion" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapse3" id="btn_productos">
					<i class="icon-browser"></i><span><?php echo $lenguaje["Productos"]; ?></span>
				</a>
				<!-- BTN #4 COLLAPSE EVENTOS -->
				<a class="menu-opcion" data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-controls="collapse4" id="btn_eventos">
					<i class="icon-cake"></i><span><?php echo $lenguaje["Eventos"]; ?></span>
				</a>
			...
			<span class="mx-5 mb-0 py-1 spm-miga text-center d-none d-lg-block"><span id="modulo">J.B.</span>/<span id="ruta"><?php echo $lenguaje["Inventario"]; ?></span></span>
		</div>
		<!-- CONTENIDO CENTRAL -->
			...
			<div class="row pr-3">
				<div class="columna col">
					<div id="accordion">
							...
							<div id="collapse1" class="collapse despliegue show" arial-labelledby="heading1" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-solicitudes">
										<iframe src="<?php echo RUTA; ?>SI/JefeBodega/iframe/Inventario/inventario" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
						<!-- CARD #2 ASPIRANTES -->
						<div class="py-0 cotizaciones">
							<div id="collapse3" class="collapse despliegue" arial-labelledby="heading3" data-parent="#accordion">
								<!-- ACORDIO DE COTIZACIONES -->
								<div class="card card-body p-0">
									<div id="accordion-eventos">
										<iframe src="<?php echo RUTA; ?>SI/JefeBodega/iframe/Productos/productos" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
						<!-- CARD #3 EMPLEADOS -->
						<div class="py-0 cotizaciones">
							<div id="collapse4" class="collapse despliegue" arial-labelledby="heading4" data-parent="#accordion">
								<!-- ACORDION DE EMPLEADOS -->
								<div class="card card-body p-0">
									<div id="accordion-eventos">
										<iframe src="<?php echo RUTA; ?>SI/JefeBodega/iframe/Eventos/eventos" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
							...
							<div id="collapse6" class="collapse despliegue" arial-labelledby="heading6" data-parent="#accordion">
								...
								<div class="card card-body p-0">
									<div id="accordion-configuracion">
										<iframe src="<?php echo RUTA; ?>SI/JefeBodega/iframe/Configuracion/configuracion" frameborder="0"></iframe>
									</div>
								</div>
							</div>
						</div>
...
<!-- SCRIPS PROPIOS -->
<script src="<?php echo RUTA; ?>js/SI/JefeBodega/scriptsJefeBodega.js"></script>
<!-- SCRIPTS ALERTA -->
...
<!-- SCRIPTS INFORMACION JEFE BODEGA -->
<script src="<?php echo RUTA; ?>json/JefeBodega/infoJefeBodega.js"></script>
<!-- SCRIPTS IDIOMA -->
<script src="<?php echo RUTA; ?>json/JefeBodega/idioma.js"></script>
<script>
